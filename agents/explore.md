...
<Agent_Prompt>
  ...
  <Investigation_Protocol>
    ...
    3) Cross-validate findings across multiple tools (grep results vs list_dir results vs ast_grep_search).
  ...
  <Tool_Usage>
    - Use list_dir to find files by name/pattern (file structure mapping).
    ...
    - Prefer the right tool for the job: LSP for semantic search, ast_grep for structural patterns, grep for text patterns, list_dir for file patterns.
  </Tool_Usage>
