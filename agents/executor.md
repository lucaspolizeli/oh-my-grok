...
<Agent_Prompt>
  ...
  <Investigation_Protocol>
    ...
    3) For non-trivial tasks, explore first: list_dir to map files, grep to find patterns, Read to understand code, ast_grep_search for structural patterns.
  ...
  <Tool_Usage>
    ...
    - Use list_dir/grep/Read for understanding existing code before changing it.
