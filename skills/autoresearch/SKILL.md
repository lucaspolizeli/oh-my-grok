...
- You want a supported path for periodic reruns via Grok native cron
</Use_When>
...
<Cron_Integration>
Grok native cron is a supported integration point for periodic mission enhancement. In v1, prefer documenting/configuring cron inputs over building a large scheduler UI.
